const About = () => {
    return (
        <section className="flex flex-col-reverse md:flex-row-reverse items-center justify-center w-full min-h-[70vh] py-12 md:py-20 px-4 sm:px-6 lg:px-8 overflow-x-hidden" id="about">
            <div className="flex-1 w-full max-w-2xl">
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 text-center mb-6 md:mb-8">About Us</h1>
