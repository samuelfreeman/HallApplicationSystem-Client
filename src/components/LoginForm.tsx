...
const LoginForm: React.FC = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className='prose border-2 border-black  rounded-md grid grid-cols-1 gap-6  w-[410px] h-[440px] p-10'>

            <h1 className='text-center pb-6 text-2xl'>Login Form</h1>
